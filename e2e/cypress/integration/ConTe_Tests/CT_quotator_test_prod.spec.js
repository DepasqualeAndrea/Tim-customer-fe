describe('QuotatorLegacyTest', function () {
    ...
    it('visit', function () {
      cy.visit('https://viaggi.conte.it/');
    ...
    it('compile-data', function (){
      cy.get('#axa-assistance-gold > div[_ngcontent-c10=""] > app-viaggi-ct > .simulator > .input-container > :nth-child(1) > .date').click()
...
//     // cy.wait(20000).then(() => {
//     //   cy.url().should('eq', 'https://yolo-insurance.com/dashboard/checkout')
//     // })
