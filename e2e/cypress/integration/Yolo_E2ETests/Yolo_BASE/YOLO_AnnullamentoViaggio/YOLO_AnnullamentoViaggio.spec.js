...
describe('T-6 Reachability form annullamento viaggio with login', () => {
    ...
    it('T-6 Clicks ok on cookie banner', () => {
        cy.get('.cc-btn').click()
    })


    it('T-6 Reaches login page', () => {
        cy.get('.user-btn > .nav-link').click()
        cy.url().should('equal', env.url + '/login')
    })


    it('T-6 Compiles login form', () => {
    ...
    it('T-6 Reaches form annullamento viaggio', () => {
