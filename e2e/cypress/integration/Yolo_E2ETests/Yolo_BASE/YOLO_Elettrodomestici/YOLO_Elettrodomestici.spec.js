...
describe('T-5 Reachability form elettrodomestici with login', () => {
    ...
    it('T-5 Clicks ok on cookie banner', () => {
        cy.get('.cc-btn').click()
    })


    it('T-5 Reaches login page', () => {
        cy.get('.user-btn > .nav-link').click()
        cy.url().should('equal', env.url + '/login')
    })


    it('T-5 Compiles login form', () => {
    ...
    it('T-5 Reaches form elettrodomestici page', () => {
