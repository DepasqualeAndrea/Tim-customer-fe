...
describe('T-17 Reachability form mobility without login', () => {
    ...
    it('T-17 Reaches Yolo home page', () => {
        cy.visit(env.url)
        cy.wait(5000)
    ...
    it('T-17 Clicks ok on cookie banner', () => {
        cy.get('.cc-btn').click()
    })


    it('T-17 Reaches products page', () => {
