...
describe('T-14 Reachability form smartphone without login', () => {
    ...
    // it('T-14 Reaches Yolo home page', () => {
    //     cy.visit(env.url)
    //     cy.wait(5000)
    ...
    // it('T-14 Clicks ok on cookie banner', () => {
    //     cy.get('.cc-btn').click()
    // })


    // it('T-14 Reaches products page', () => {
    ...
    it('T-14 Reaches form smartphone', () => {
