...
describe('T-7 Reachability form sport with login', () => {
  ...
  it('T-7 Clicks ok on cookie banner', () => {
    cy.get('.cc-btn').click()
  })


  it('T-7 Reaches login page', () => {
    cy.get('.user-btn > .nav-link').click()
    cy.url().should('equal', env.url + '/login')
  })


  it('T-7 Compiles login form', () => {
