...
describe('T-31 Reachability form viaggio europa without login', () => {
    ...
    it('T-31 Reaches Yolo home page', () => {
        cy.visit(env.url)
        cy.wait(5000)
    ...
    it('T-31 Clicks ok on cookie banner', () => {
        cy.get('.cc-btn').click()
    })


    it('T-31 Reaches products page', () => {
    ...
    it('T-31 Reaches form viaggio europa', () => {
