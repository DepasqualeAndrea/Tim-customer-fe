...
export class CheckoutAxaAnnullamentoViaggioContentService implements CheckoutContentProvider {
  ...
  private getContentFromKentico(): Observable<any> {
    return this.kenticoTranslateService.getItem('checkout_annullamento_viaggio').pipe
  ...
  createContentStructureFromKenticoItem(kenticoItem: any) {
    const structure = {
      ...
      cost_item: {
        ...
        info_set: kenticoItem.shopping_cart___desktop.value.find(item => item.system.codename === 'set_info_viaggio').set_informativo.value,
