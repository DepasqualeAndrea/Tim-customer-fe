...
export class CheckoutGeHomeContentService implements CheckoutContentProvider {
  ...
  createContentStructureFromKenticoItem(kenticoItem: any) {
    const structure = {
      ...
      card_insured: {
        title: kenticoItem.card_list.card_insured_home_genertel.title.value,
        metri_q: kenticoItem.card_list.card_insured_home_genertel.metri_q.value,
        province: kenticoItem.card_list.card_insured_home_genertel.province.value,
        maximal: kenticoItem.card_list.card_insured_home_genertel.maximal.value,
        maximal_conduction: kenticoItem.card_list.card_insured_home_genertel.maximal_conduction.value,
        payment: kenticoItem.card_list.card_insured_home_genertel.payment.value,
  ...
  private getContentFromKentico(): Observable<any> {
    return this.kenticoTranslateService.getItem('checkout_home_genertel').pipe
