...
import { CheckoutYoloAnnulamentoViaggioContent } from '../content/checkout-yolo-annullamento-viaggio-content.model';
import { CheckoutAxaAnnullamentoViaggioContentService } from '../content/checkout-axa-annullamento-viaggio-content.service';
import _ from "lodash";


export class CheckoutLinearStepperYoloAnnullamentoViaggioReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  private setContent(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setContentCollaborationSection(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setContentHeader(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setContentCompletedSteps(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent) {
  ...
  private setUncompletedStepTitles(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent) {
  ...
  private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setContentInsuranceHolder(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setContentSurvey(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  public setCostItemDetailsContent(state: CheckoutLinearStepperGenericState, content: CheckoutYoloAnnulamentoViaggioContent): CheckoutLinearStepperGenericState {
  ...
  private setCostItemListCoverages(state: CheckoutLinearStepperGenericState, variant: any) {
    ...
    if (variant.product_properties.alias === 'annullamento-viaggio') {
