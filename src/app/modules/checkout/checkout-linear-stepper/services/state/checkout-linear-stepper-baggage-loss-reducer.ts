...
export class CheckoutLinearStepperBaggageLossReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState, content: CheckoutBaggageLossContent): CheckoutLinearStepperGenericState {
    ...
    state.completed_steps.insurance_info.display_data[2].label = content.card_insured.booking_id;
    return state;
  }
  ...
  private setInsured(state: CheckoutLinearStepperGenericState, order: ResponseOrder): CheckoutLinearStepperGenericState {
    ...
    displayData[2].value = lineItem.insurance_info.booking_id;
