...
import { CheckoutGeBikeContent } from '../content/checkout-ge-bike-content.model';



export class CheckoutLinearStepperGeBikeReducer extends CheckoutLinearStepperGenericReducer
  ...
  public setCostItemDetail(state: CheckoutLinearStepperGenericState, order: ResponseOrder): CheckoutLinearStepperGenericState {
    this.state.model.product.code === 'ge-bike-plus'
  ...
  private setContent(state: CheckoutLinearStepperGenericState
    , content: CheckoutGeBikeContent): CheckoutLinearStepperGenericState {
  ...
  private setUncompletedStepTitles(state: CheckoutLinearStepperGenericState, content: CheckoutGeBikeContent) {
  ...
  private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState,
    ...
    state.completed_steps.insurance_info.kentico_insurance_info.package = content.card_bike.package;
    state.completed_steps.insurance_info.kentico_insurance_info.insured = content.card_bike.insured;
