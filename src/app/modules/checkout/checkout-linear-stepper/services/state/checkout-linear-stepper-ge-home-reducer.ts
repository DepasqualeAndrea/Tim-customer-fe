...
export class CheckoutLinearStepperGeHomeReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  private setContent(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent): CheckoutLinearStepperGenericState {
  ...
  private setCostItemDetailsContent(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent): CheckoutLinearStepperGenericState {
      ...
      addons.forEach(addon => {
        if (addon.id === item.code.value) {
          ...
          if (addon.maximal && addon.maximal !== 0 && (addon.id === 'RC proprieta' || addon.id === 'RC conduzione' || addon.id === 'HOME Fabbricato Inc.')) {
            massimale = '(massimale ' + (addon.massimale ? addon.massimale : addon.maximal) + this.getCurrenySymbol(state) + ')';
          }
  ...
  private setContentCompletedSteps(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent) {
  ...
  private setUncompletedStepTitles(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent) {
  ...
  private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent): CheckoutLinearStepperGenericState {
  ...
  private setContentInsuranceHolder(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent): CheckoutLinearStepperGenericState {
  ...
  private setContentSurvey(state: CheckoutLinearStepperGenericState, content: CheckoutGeHomeContent): CheckoutLinearStepperGenericState {
