...
export class CheckoutLinearStepperGeSkiReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  private setHeader(state: CheckoutLinearStepperGenericState, order: ResponseOrder): CheckoutLinearStepperGenericState {
    ...
    state.checkout_header.product_name = state.model.product.code === 'ge-ski-plus' ?  state.checkout_header.assicurazione_sci_plus : state.checkout_header.assicurazione_sci_premium;    
  ...
  public setCostItemDetail(state: CheckoutLinearStepperGenericState, order: ResponseOrder): CheckoutLinearStepperGenericState {
    ...
    this.state.model.product.code === 'ge-ski-plus'
    ...
    state.cost_item.product_name = state.model && this.state.model.product.code === 'ge-ski-plus'
    ...
    state.model && state.model.product.code === 'ge-ski-plus'
