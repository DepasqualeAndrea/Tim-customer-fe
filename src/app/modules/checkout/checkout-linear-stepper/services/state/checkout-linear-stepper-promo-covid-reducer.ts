...
import { CheckoutMoparCovidContent } from '../content/checkout-mopar-covid-content.model';

export class CheckoutLinearStepperPromoCovidReducer extends CheckoutLinearStepperGenericReducer
    ...
    private setContent(state: CheckoutLinearStepperGenericState
        , content: CheckoutMoparCovidContent): CheckoutLinearStepperGenericState {
    ...
    private setContentCompletedSteps(state: CheckoutLinearStepperGenericState, content: CheckoutMoparCovidContent) {
    ...
    private setUncompletedStepTitles(state: CheckoutLinearStepperGenericState, content: CheckoutMoparCovidContent) {
        state.uncompleted_step_titles = [
            {
                name: 'insurance-info',
                title: content.card_covid.title
            },
            {
                name: 'address',
    ...
    private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState, content: CheckoutMoparCovidContent): CheckoutLinearStepperGenericState {
        state.completed_steps.insurance_info.title = content.card_covid.title;
        state.completed_steps.insurance_info.display_data[0].label = content.card_covid.coverage_start_date;
        state.completed_steps.insurance_info.display_data[1].label = content.card_covid.coverage_expiration_date;
        return state;
    }
    private setContentInsuranceHolder(state: CheckoutLinearStepperGenericState, content: CheckoutMoparCovidContent): CheckoutLinearStepperGenericState {
    ...
    private setContentSurvey(state: CheckoutLinearStepperGenericState, content: CheckoutMoparCovidContent): CheckoutLinearStepperGenericState {
