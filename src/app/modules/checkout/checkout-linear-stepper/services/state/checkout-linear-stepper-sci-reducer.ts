...
export class CheckoutLinearStepperSciReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  public setCostItemDetail(state: CheckoutLinearStepperGenericState, order: ResponseOrder): CheckoutLinearStepperGenericState {
    state.cost_item.informative_set = state.model && state.model.product.code === 'erv-mountain-gold'
