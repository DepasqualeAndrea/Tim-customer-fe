...
import { CheckoutTimForSkiContent } from '../content/checkout-tim-for-ski-content.model';

export class CheckoutLinearStepperTimForSkiReducer extends CheckoutLinearStepperGenericReducer implements CheckoutLinearStepperReducer {
  ...
  private setContent(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
  ...
  private setContentHeader(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
  ...
  private setCostItemDetailsContent(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
  ...
  private setContentCompletedSteps(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent) {
  ...
  private setUncompletedStepTitles(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent) {
  ...
  private setContentInsuranceInfo(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
    ...
    state.completed_steps.insurance_info.display_data[2].label = content.card_insured.image;
    return state;
  }

  private setContentInsuranceHolder(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
  ...
  private setContentSurvey(state: CheckoutLinearStepperGenericState, content: CheckoutTimForSkiContent): CheckoutLinearStepperGenericState {
  ...
  private seasonHasEnded(order: ResponseOrder): boolean {
    const seasonEnd = order.line_items[0].expiration_date;
  ...
  private seasonHasStarted(order: ResponseOrder): boolean {
    const seasonStart = order.line_items[0].start_date;
