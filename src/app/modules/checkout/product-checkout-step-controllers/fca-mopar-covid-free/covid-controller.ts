...
import { CovidInfoStepController } from './covid-info-step-controller';

@Injectable({
  providedIn: 'root'
})
export class CovidController implements ProductCheckoutController {
  constructor(private productLoginRegisterStepController: ProductLoginStepBaseController
    , private productInfoStepController: CovidInfoStepController
