...
import { GeBikeLoginStepController } from './ge-bike-login-step-controller';
...
export class GeBikeController implements ProductCheckoutController {
    constructor(private loginRegisterStepController: GeBikeLoginStepController,
