...
import { IntesaPetStepsController } from './intesa-pet-steps-controller';
import { ProductStepsController } from '../product-steps-controller.interface';

@Injectable({
    providedIn: 'root'
})
export class IntesaPetController implements ProductCheckoutController {
    constructor(private productLoginRegisterStepController: ProductLoginStepBaseController
        ...
        , private productStepsController: IntesaPetStepsController) {
    }
