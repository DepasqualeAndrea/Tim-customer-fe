...
import { ScreenProtectionInfoStepController } from './screen-protection-info-step-controller';

@Injectable({
  providedIn: 'root'
})
export class ScreenProtectionController implements ProductCheckoutController {
  constructor(
      private productLoginRegisterStepController: ProductLoginStepBaseController
    , private productInfoStepController: ScreenProtectionInfoStepController
