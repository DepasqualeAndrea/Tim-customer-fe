...
import { MypetLoginStepController } from './mypet-login-controller';
import { MypetInfoStepController } from './mypet-info-step-controller';

@Injectable({
  providedIn: 'root'
})
export class MyPetController implements ProductCheckoutController {
  constructor(
      private productLoginRegisterStepController: MypetLoginStepController
    , private productInfoStepController: MypetInfoStepController
