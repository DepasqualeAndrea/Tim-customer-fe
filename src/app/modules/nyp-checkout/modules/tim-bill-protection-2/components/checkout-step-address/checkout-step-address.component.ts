...
@Component({
  ...
  styleUrls: ['./checkout-step-address.component.scss', '../../../../styles/size.scss', '../../../../styles/colors.scss', '../../../../styles/text.scss', '../../../../styles/common.scss']
})
export class CheckoutStepAddressComponent implements OnInit {
  ...
  titleStates: CheckoutStates[] = ['insurance-info', 'login-register'];
