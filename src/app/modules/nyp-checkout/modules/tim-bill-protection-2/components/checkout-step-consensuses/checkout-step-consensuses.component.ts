...
@Component({
    ...
    styleUrls: ['./checkout-step-consensuses.component.scss', '../../../../styles/size.scss', '../../../../styles/colors.scss', '../../../../styles/text.scss', '../../../../styles/common.scss'],
      ...
      Object.entries(value)
        .forEach(([k, v]) => {
          if (this.latestForm[k] != v && !!v) {
            ...
            switch (k) {
              case 'uno': {
                source = this.kentico.transform('tim_bill_protection.checkbox_documents_acceptance_1_bp');
              }; break;
              case 'tre': {
