...
import { TimBillProtectionApiService } from 'app/modules/nyp-checkout/modules/tim-bill-protection-2/services/api.service';
import { TIM_BILL_PROTECTION_2_KENTICO_NAME, TIM_BILL_PROTECTION_2_KENTICO_SLUG } from 'app/modules/nyp-checkout/nyp-checkout.module';
...
export class PolicyDetailBasicTimBillProtectionComponent extends PolicyDetailRecapDynamicComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.Warranties$ = this.nypDataService
      .downloadKenticoContent(TIM_BILL_PROTECTION_2_KENTICO_NAME, TIM_BILL_PROTECTION_2_KENTICO_SLUG)
      .pipe(
