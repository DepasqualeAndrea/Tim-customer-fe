...
import { TimBillProtectorApiService } from 'app/modules/nyp-checkout/modules/tim-bill-protector/services/api.service';
import { TIM_BILL_PROTECTOR_KENTICO_NAME, TIM_BILL_PROTECTOR_KENTICO_SLUG } from 'app/modules/nyp-checkout/nyp-checkout.module';
...
@Component({
  selector: 'app-policy-detail-basic-tim-bill-protector',
  templateUrl: './policy-detail-basic-tim-bill-protector.component.html',
  styleUrls: ['./policy-detail-basic-tim-bill-protector.component.scss']
})
export class PolicyDetailBasicTimBillProtectorComponent extends PolicyDetailRecapDynamicComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.Warranties$ = this.nypDataService
      .downloadKenticoContent(TIM_BILL_PROTECTOR_KENTICO_NAME, TIM_BILL_PROTECTOR_KENTICO_SLUG)
      .pipe(
