...
import { PolicyDetailBasicTimBillProtectorComponent } from "./components/policy-detail-basic-tim-bill-protector/policy-detail-basic-tim-bill-protector.component";
...
import { TimBillProtectorCheckoutResolver } from "./services/checkout.resolver";
...
const routes: Routes = [
  {
    ...
    resolve: { input: TimBillProtectorCheckoutResolver },
    children: [
      { path: "login-register",  canDeactivate: [CheckoutDeactivateGuard]  },
      { path: "user-control", component: CheckoutExistingPolicyComponent},
...
@NgModule({
  declarations: [
    ...
    PolicyDetailBasicTimBillProtectorComponent,
...
export class TimBillProtectorModule {}
