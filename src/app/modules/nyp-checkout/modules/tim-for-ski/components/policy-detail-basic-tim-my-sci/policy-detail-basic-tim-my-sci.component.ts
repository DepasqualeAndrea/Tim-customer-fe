...
import { TIM_FOR_SKI_KENTICO_NAME, TIM_FOR_SKI_KENTICO_SLUG } from 'app/modules/nyp-checkout/nyp-checkout.module';
...
export class PolicyDetailBasicTimMySciComponent extends PolicyDetailRecapDynamicComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.Warranties$ = this.nypDataService
      .downloadKenticoContent(TIM_FOR_SKI_KENTICO_NAME, TIM_FOR_SKI_KENTICO_SLUG)
      .pipe(
