...
import { PolicyDetailBasicTimMySciComponent } from "./components/policy-detail-basic-tim-my-sci/policy-detail-basic-tim-my-sci.component";
...
import { TimForSkiCheckoutResolver } from "./services/checkout.resolver";
import { TimForSkiServiceModule } from "./tim-for-ski.service-module";
import { TimForSkiPreventivatoreResolver } from "./services/preventivatore.resolver";
...
const routes: Routes = [
  {
    path: "",
    resolve: { input: TimForSkiPreventivatoreResolver },
    children: [
      {
        path: "preventivatore",
        component: PreventivatoreComponent,
      },
      {
        path: "",
        component: CheckoutOrchestratorComponent,
        resolve: { input: TimForSkiCheckoutResolver },
        children: [
