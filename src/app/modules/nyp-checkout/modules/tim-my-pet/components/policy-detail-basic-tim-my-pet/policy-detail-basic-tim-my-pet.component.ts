...
import { TIM_MY_PET_KENTICO_NAME, TIM_MY_PET_KENTICO_SLUG } from 'app/modules/nyp-checkout/nyp-checkout.module';
...
@Component({
  selector: 'app-policy-detail-basic-tim-my-pet',
  templateUrl: './policy-detail-basic-tim-my-pet.component.html',
  styleUrls: ['./policy-detail-basic-tim-my-pet.component.scss']
})
export class PolicyDetailBasicTimMyPetComponent extends PolicyDetailRecapDynamicComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.Warranties$ = this.nypDataService
      .downloadKenticoContent(TIM_MY_PET_KENTICO_NAME, TIM_MY_PET_KENTICO_SLUG)
      .pipe(
