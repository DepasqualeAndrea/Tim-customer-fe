...
import { TimProtezioneViaggiBreveCheckoutService } from '../../services/checkout.service';
...
export class CheckoutOrchestratorComponent implements OnInit {
  ...
  constructor(public checkoutService: TimProtezioneViaggiBreveCheckoutService, public nypDataService: NypDataService) { }
