...
export class CheckoutStepLoginComponent implements OnInit {
  ...
  getKenticoContent() {
    this.kenticoTranslateService.getItem<any>('access_customers').pipe(
      take(1),
      tap(() => console.log(TIM_PROTEZIONE_VIAGGI_EUROPE_BREVE_PRODUCT_NAME, TIM_PROTEZIONE_VIAGGI_WORLD_BREVE_PRODUCT_NAME, 'processing old-fashioned login translation')),
      map(kenticoItem => ({
      ...
      tap(() => console.log(TIM_PROTEZIONE_VIAGGI_EUROPE_BREVE_PRODUCT_NAME, TIM_PROTEZIONE_VIAGGI_WORLD_BREVE_PRODUCT_NAME, 'processed old-fashioned translation')),
