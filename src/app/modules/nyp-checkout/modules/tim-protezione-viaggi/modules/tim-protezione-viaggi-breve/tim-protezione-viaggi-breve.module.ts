...
import { TimProtezioneviaggiBreveCheckoutResolver } from "./services/checkout.resolver";
...
import { TimProtezioneViaggiBrevePreventivatoreResolver } from "./services/preventivatore.resolver";
...
const routes: Routes = [
  {
    path: "",
    resolve: { input: TimProtezioneViaggiBrevePreventivatoreResolver },
    children: [
      { path: "preventivatore", component: PreventivatoreComponent },
      {
        path: "",
        component: CheckoutOrchestratorComponent,
        resolve: { input: TimProtezioneviaggiBreveCheckoutResolver },
        children: [
...
@NgModule({
  ...
  imports: [
    ...
    NgbModule,
    NypStripeModule,
    TimProtezioneViaggiBreveServiceModule,
    SellerCodeModule,
    SharedDirectivesModule
  ],
  providers: [CheckoutDeactivateGuard],
})
export class TimProtezioneViaggiBreveModule {}
