...
export class CheckoutOrchestratorComponent implements OnInit {
  summaryStates: CheckoutStates[] = ['login-register', 'address', 'consensuses', 'survey', 'user-control'];
  ...
  constructor(public checkoutService: TimSportCheckoutService, public nypDataService: NypDataService) { }
