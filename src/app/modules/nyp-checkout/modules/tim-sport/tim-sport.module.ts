...
import { PolicyDetailBasicTimSportComponent } from "./components/policy-detail-basic-tim-sport/policy-detail-basic-tim-sport.component";
import { ShoppingCartComponent } from "./components/shopping-cart/shopping-cart.component";
import { TimSportCheckoutResolver } from "./services/checkout.resolver";
...
const routes: Routes = [
  {
    ...
    resolve: { input: TimSportCheckoutResolver },
    children: [
      {
        path: "insurance-info",
...
@NgModule({
  declarations: [
    ...
    PolicyDetailBasicTimSportComponent,
