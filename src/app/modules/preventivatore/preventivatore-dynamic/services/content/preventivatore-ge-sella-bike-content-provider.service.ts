...
export class PreventivatoreGeSellaBikeContentProviderService implements PreventivatoreContentProvider {
  ...
  createContentStructureFromKenticoItem(kenticoItem: any) {
    const structure = {
      ...
      how_works: {
        ...
        text_section: kenticoItem.how_works.value.find(item => item.system.codename === 'how_works_bike_description').text.value,
        product_content: this.getPolicyCoverages(kenticoItem.how_works.value.find(item => item.system.codename === 'how_works_bike').container),
      ...
      what_to_know: {
        ...
        text_section: kenticoItem.what_to_know.value.find(item => item.system.codename === 'what_to_know_bike').text.value,
        set_informativo_content: kenticoItem.what_to_know.value.find(item => item.system.codename === 'informative_set_plus_premium_bike').text.value
      },
      faq: {
      ...
      more_info: {
        title: kenticoItem.more_info.value.find(item => item.system.codename === 'more_info_title_bike').text.value,
        subtitle: kenticoItem.more_info.value.find(item => item.system.codename === 'more_info_text_bike_genertel').text.value,
      }
    };
    return structure;
  }
  ...
  getPolicyCoverages(benefits: any) {
    ...
    benefits.value.map(benefit => {
      const policyCoverage = {
        ...
        product_code: benefit.system.codename.endsWith('bike_plus') ? 'ge-bike-plus' : 'ge-bike-premium',
