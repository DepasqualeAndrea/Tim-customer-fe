...
export class PreventivatoreGeSellaSkiInstantContentProviderService implements PreventivatoreContentProvider {
  ...
  private getContentFromKentico(): Observable<any> {
    return this.kenticoTranslateService.getItem('preventivatore_ski_instant_genertel').pipe
  ...
  createContentStructureFromKenticoItem(kenticoItem: any) {
    const structure = {
      ...
      quotator: {
        policy: kenticoItem.quotator.value.find(item => item.system.codename === 'new_policy_quotator').text.value,
      ...
      what_to_know: {
        title_section: kenticoItem.what_to_know.value[3].title.value,
        text_section: kenticoItem.what_to_know.value[3].text.value,
        slider_content: kenticoItem.what_to_know.value[3].infocards.value.map(card => {
          return {
        ...
        policy_note_content: kenticoItem.what_to_know.value[3].additional_info ? kenticoItem.what_to_know.value[3].additional_info.value : null,
        set_informativo_content: kenticoItem.what_to_know.value[3].information_package ? kenticoItem.what_to_know.value[3].information_package.value : null
      },
      more_info: {
        title: kenticoItem.more_info.contattaci_ski.title.value,
        subtitle: kenticoItem.more_info.contattaci_ski.body.value,
      },
      faq: {
  ...
  getPolicyCoverages(benefits: any) {
    ...
    benefits.value.map(benefit => {
      const policyCoverage = {
        ...
        product_code: benefit.system.codename.endsWith('ski_plus') ? 'ge-ski-plus' : 'ge-ski-premium',
