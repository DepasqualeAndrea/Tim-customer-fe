...
export class PreventivatoreGenertelSciContentProviderService {
  ...
  //   // return this.kenticoTranslateService.getItem('preventivatore_ski_instant').pipe
  ...
  createContentStructureFromKenticoItem(kenticoItem: any) {
    ...
    //     text_section: kenticoItem.how_works.value.find(item => item.system.codename === 'how_works_ski_description').text.value,
    //     product_content: this.getPolicyCoverages(kenticoItem.how_works.value.find(item => item.system.codename === 'how_works_ski_instant').container),
    ...
    //     text_section: kenticoItem.what_to_know.value.find(item => item.system.codename === 'what_to_know_ski_instant').text.value,
    //     set_informativo_content: kenticoItem.what_to_know.value.find(item => item.system.codename === 'informative_set_plus_premium_istant').text.value
    //   },
    //   more_info: {
  ...
  getContent(codes: string[]): Observable<ContentInterface> {
    ...
    // return contentFromKentico$.pipe(switchMap((contentFromKentico) => {
      ...
      obj.container_1 = Object.assign({}, this.setContentToProduct(contentFromInsuranceService, {}));
