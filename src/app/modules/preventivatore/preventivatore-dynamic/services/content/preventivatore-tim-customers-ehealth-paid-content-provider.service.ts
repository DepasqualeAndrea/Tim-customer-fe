...
export class PreventivatoreTimCustomersEhealthPaidContentProviderService implements PreventivatoreContentProvider {
  ...
  private getContentFromKentico(): Observable<any> {
    return this.kenticoTranslateService.getItem('preventivatore_ehealth_quixa_standard').pipe
  ...
  private setContentToProduct(contentFromInsuranceService: any, hero: any) {
    const product = contentFromInsuranceService.find(product => product.product_code === 'ehealth-quixa-standard')
    const obj = {
      product: product,
      title: hero.title,
