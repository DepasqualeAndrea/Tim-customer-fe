...
export class PreventivatoreYoloForPetContentProvider implements PreventivatoreContentProvider {
  ...
  createContentStructureFromKenticoItem(codes: string[], kenticoItem: any) {
    const structure = {
      ...
      quotator: {
        ...
        continue_button_label: kenticoItem.quotator.value.find(item => item.system.codename === 'purchase_button') ?
          kenticoItem.quotator.value.find(item => item.system.codename === 'purchase_button').text.value :
          kenticoItem.quotator.value.find(item => item.system.codename === 'continue_button').text.value,
        frequency_payment: kenticoItem.quotator.value.find(item => item.system.codename === 'frequency_payment').text.value,
      },
      ...
      more_info: {
        ...
        route: kenticoItem.product_found.value.find(item => item.system.codename === 'contatti_route') ?
          kenticoItem.product_found.value.find(item => item.system.codename === 'contatti_route').text.value :
          kenticoItem.product_found.value.find(item => item.system.codename === 'assistance_route').text.value
      },
      for_who: {
  ...
  private getContentFromKentico(codes: string[]): Observable<any> {
    return this.kenticoTranslateService.getItem('preventivatore_yolo_for_pet').pipe
