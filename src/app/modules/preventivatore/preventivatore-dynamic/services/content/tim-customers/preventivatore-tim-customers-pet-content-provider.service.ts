...
export class PreventivatoreTimCustomersPetContentProviderService implements PreventivatoreContentProvider {
  ...
  private getContentFromKentico(): Observable<any> {
    return this.kenticoTranslateService.getItem('preventivatore_tim_customers_pet').pipe
  ...
  private setContentToProduct(contentFromInsuranceService: any, hero: any) {
    const product = contentFromInsuranceService.find(product => product.product_code === 'customers-tim-pet');
    const obj = {
      product: product,
      title: hero.title,
