...
import { AdditionalSingleCoveragesComponent } from '../../components/additional-single-coverages/additional-single-coverages.component';

@Injectable({
  providedIn: 'root'
})
export class FAQableVariantsSGLayout implements PreventivatoreComponentProvider {
  ...
  getComponents(): ComponentFactory<PreventivatoreAbstractComponent>[] {
    return [
      ...
      this.componentFactoryResolver.resolveComponentFactory(AdditionalSingleCoveragesComponent),
