...
export class ServiceFaqVariantsLayoutService implements PreventivatoreComponentProvider {
  ...
  getComponents(): ComponentFactory<PreventivatoreAbstractComponent>[] {
    ...
    //   this.componentFactoryResolver.resolveComponentFactory(ServiceProductCardComponent),
